...
#         if IP in packet:
#             ip_layer = packet[IP]
#             packet_info = f"Source: {ip_layer.src}, Destination: {ip_layer.dst}, Protocol: {packet.proto}, Payload: {bytes(packet[IP].payload)}\n"
#             # Insert packet information into the text box
...
#         """Captures packets"""
#         sniff(prn=self.packet_handler, stop_filter=lambda x: not self.sniffing)
...
# import socket  # To map protocol numbers to names
...
#         try:
#             return socket.getprotobyname(socket.getservbyport(proto))
#         except (OSError, ValueError):
#             # Handle common protocols if getprotobyname doesn't return anything
#             if proto == 6:
#                 return "TCP"
#             elif proto == 17:
#                 return "UDP"
